...
if (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    if ($wtInstalled) {
        Start-Process wt.exe -ArgumentList "$powershellcmd -ExecutionPolicy Bypass -File $MyInvocation -Run" -Verb RunAs
    } else {
        Start-Process $powershellcmd -ArgumentList "-ExecutionPolicy Bypass -File $MyInvocation -Run" -Verb RunAs
    }
